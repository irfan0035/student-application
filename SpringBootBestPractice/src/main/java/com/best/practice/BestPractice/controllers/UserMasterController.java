...
public class UserMasterController {
    ...
    //
    public ResponseEntity<UserMasterDto> addUser(@Validated(UserValidator.Create.class)
                                                     @RequestBody @JsonView({UserView.Create.class})UserMasterDto createUserMasterDto) {

        UserMasterDto responseUserMasterDto;
        try {
